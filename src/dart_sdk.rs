...
extern "C" {
  pub fn Dart_GetNativeInstanceFieldCount(obj: Dart_Handle, count: *mut libc::c_int)
    -> Dart_Handle;
}
extern "C" {
...
extern "C" {
  pub fn Dart_WriteProfileToTimeline(main_port: Dart_Port, error: *mut *mut libc::c_char) -> bool;
}
extern "C" {
